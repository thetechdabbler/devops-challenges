export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontSize: '2rem', fontWeight: 800 }}>DevOps Practice Portal</h1>
      <p style={{ color: '#94a3b8', maxWidth: 400, textAlign: 'center' }}>
        Learn DevOps by doing — Docker, Kubernetes, CI/CD, Ansible, IaC, Observability, and more.
      </p>
      {error && (
      ...
      <a
        ...
        style={{
          ...
          padding: '0.75rem 1.5rem', background: '#24292e', color: '#fff',
